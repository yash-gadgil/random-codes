...
def windef(a,b,c,boole): return (boardspace[a] == boole) and (boardspace[b] == boole) and (boardspace[c] == boole) if (boardspace[a] != None) and (boardspace[b] != None) and (boardspace[c] != None) else False
        ...
        if tno == 0:
            ...
            if int(board[0]) in corners:
                ...
                if board[1] == "4":
                    ...
                    if recent == opposite[board[0]]:
                    ...
                    elif recent in adjc[str(opposite[board[0]])]:
                        
                        choices = adjm[board[1]]
                        choices.remove(opposite[board[0]])
                        choices.remove(4)
                        ...
                        block = opposite[board[1]]
                        board += str(block)

                    else:

                        block = opposite[str(win2[board])]
                        board += str(block)
                ...
                try:
                    ...
                    if str(win2[board[0] + board[2]]) not in board:
                        ...
                        try:
                            ...
                            if opposite[board[0]] == int(board[1]):
                                
                                for j in range(3): corners.remove(int(board[j]))
                                cornersleft = corners.copy()
                                for j in range(3): corners.append(int(board[j]))

                                block = choice(cornersleft)
                                board += str(block)

                            elif int(board[1]) in corners:

                                block = opposite[board[0]]
                                board += str(block)
            ...
            if xx == 3:
                ...
                for i in [1,3,5]:
                    ...
                    try:
                        ...
                        if str(win2[board[i] + board[k]]) not in board:
                            ...
                            xx += 1
                            if int(board[i]) in corners: xxx += 1
                ...
                if xx == 3:
                    ...
                    if xxx == 2:
                        ...
                        for i in corners:
                            if str(i) not in board: movesss = [i]
            ...
            if ttt == 3:
                ...
                if ttt == 6:
                    ...
                    movess = [i for i in range(9) if str(i) not in board]
